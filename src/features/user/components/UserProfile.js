        ...
        <div className="border-t border-gray-200 ">
          ...
          {user.addresses.map((address, index) => (
            <div>
                  ...
                  <div className=" space-y-12">
                    ...
                    <div className="mt-6 flex items-center justify-end gap-x-6">
                      <button
                        ...
                        type="submit"
                        className="rounded-md bg-white-600 px-3 py-2 text-sm font-semibold text-grey shadow-sm hover:bg-grey-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                      >
                        Cancel
                      </button>
                      <button
              ...
              <div className=" flex justify-between gap-x-6 px-0 py-5  ">
